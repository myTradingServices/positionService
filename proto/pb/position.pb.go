...
func (x *RequestPositioner) Reset() {
	*x = RequestPositioner{}
...
func (x *RequestPositioner) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RequestPositioner) ProtoMessage() {}

func (x *RequestPositioner) ProtoReflect() protoreflect.Message {
	mi := &file_position_proto_msgTypes[0]
...
// Deprecated: Use RequestPositioner.ProtoReflect.Descriptor instead.
func (*RequestPositioner) Descriptor() ([]byte, []int) {
	return file_position_proto_rawDescGZIP(), []int{0}
}

func (x *RequestPositioner) GetOpen() bool {
	if x != nil {
		return x.Open
	}
	return false
...
func (x *RequestPositioner) GetBuy() bool {
	if x != nil {
		return x.Buy
	}
	return false
...
func (x *RequestPositioner) GetOperationID() string {
	if x != nil {
...
func (x *RequestPositioner) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *RequestPositioner) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
var file_position_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x8b, 0x01, 0x0a, 0x11, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x6f, 0x73,
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6f, 0x70, 0x65, 0x6e, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x6f, 0x70, 0x65, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x62,
	0x75, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x62, 0x75, 0x79, 0x12, 0x20, 0x0a,
	...
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f,
	0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x32,
	0x4b, 0x0a, 0x08, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x3f, 0x0a, 0x0a, 0x50,
	0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x72,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50, 0x6f, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x65, 0x72,
	0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62,
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x00, 0x28, 0x01, 0x42, 0x05, 0x5a, 0x03,
...
var file_position_proto_goTypes = []interface{}{
	(*RequestPositioner)(nil), // 0: pb.requestPositioner
	(*emptypb.Empty)(nil),     // 1: google.protobuf.Empty
}
var file_position_proto_depIdxs = []int32{
	0, // 0: pb.Position.Positioner:input_type -> pb.requestPositioner
	1, // 1: pb.Position.Positioner:output_type -> google.protobuf.Empty
...
func file_position_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_position_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RequestPositioner); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
